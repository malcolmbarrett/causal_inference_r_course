...
### For causal inference, we need to make sometimes unverifiable assumptions to imbue statistical results with causal meaning
...
::: {.small}
- **Instrumental variables**: a variable affects the treatment but does not affect the outcome except through the treatment
