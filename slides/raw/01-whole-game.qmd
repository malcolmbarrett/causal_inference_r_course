...
## Let's fix our confidence intervals with ipw()! {.small}

```{r}
tidy(ipw_fit, conf.int = TRUE)
```
...
## Re-estimate the effect with the confounder measured {.small}
...
### *Our causal effect estimate: **-10.2 (95% CI -11.2, -9.3)***
