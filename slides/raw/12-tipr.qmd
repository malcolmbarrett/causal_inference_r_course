...
That is a fact about how the test works, not a missing arrow

## The two household pairs
...
::: nonincremental
- These data are simulated, so genetic resistance was ours to add to the tests
- In a real analysis it would never be in our data, and these tests stay silent about what is not there
- What is left is to quantify what an unmeasured confounder would do to the estimate
:::
