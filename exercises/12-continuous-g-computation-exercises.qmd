...
2. `wait_minutes_posted_avg` has enough repeated values to read as categorical, so declare the exposure type.
...
Both are a small fraction of the 85 days in the data, and the 60 minute clone is the smaller of the two. That is the same shortage of support the wide interval in Your Turn 4 reports.
