...
The conditional reading reports the outcome model's own coefficients. The per-minute slope matches the marginal `slope` row, and the intercept comes with it. The marginal reading is the estimand; the conditional reading is the regression table.
