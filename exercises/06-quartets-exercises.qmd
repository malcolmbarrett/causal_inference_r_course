...
`causal_quartet` has all four datasets stacked on top of one another, with the names of their data generating mechanisms hidden.
...
For each of the 4 datasets, fit a linear model to examine the relationship between the `exposure` and the `outcome`
