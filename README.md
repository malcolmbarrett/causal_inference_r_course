...
- [07 Introduction to Propensity
  Scores](https://causal-inference-r-workshop.netlify.app/07-pscores.html)
- [08 Using Propensity
  Scores](https://causal-inference-r-workshop.netlify.app/08-using-pscores.html)
- [09 Checking Propensity
  Scores](https://causal-inference-r-workshop.netlify.app/09-pscore-diagnostics.html)
- [10 Fitting the outcome
  model](https://causal-inference-r-workshop.netlify.app/10-outcome-model.html)
...
- [16 Bonus: Continuous Exposures with Propensity
  Scores](https://causal-inference-r-workshop.netlify.app/16-bonus-continuous-pscores.html)
- [17 Bonus: Machine Learning for Causal
  Inference](https://causal-inference-r-workshop.netlify.app/17-bonus-ml-for-causal.html)
